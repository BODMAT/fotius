...
import { blockFromRightAnimation, textFromTopAnimation } from "../animations/animations";
            ...
            <div className="max-w-[1300px] m-[0_auto] box-content pr-[15px] pl-[15px]">
                <div className="flex justify-beetwen items-center gap-5 max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:text-center max-lg:m-[0_auto]">
                    <div className="flex flex-col justify-center  gap-[5px]">
                        ...
                        <motion.h1 variants={textFromTopAnimation} className="third-family font-bold text-[60px] leading-[1.2] capitalize dark:text-[#17254e] text-[#2d4796] transitioned max-sm:text-[40px]">Achieving Your Dreams Through Education</motion.h1>
